  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-3xl text-[var(--fg-strong)]">Panel de Administración</h1>
          <p className="text-sm text-[var(--fg-muted)]">
            Navega entre módulos y gestiona la operación de <BrandWordmark />.
          </p>
          <p className="mt-1 text-xs text-[var(--fg-soft)]">
            Sesión activa: {session?.sub ?? "usuario"} ({roleLabel})
          </p>
        </div>
        <AdminLogoutButton />
      </div>
